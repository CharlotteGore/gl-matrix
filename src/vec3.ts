 ...
 * @returns {vec3} out
 */
export const hermite = (out: Vec3, a: Readonly<Vec3>, b: Readonly<Vec3>, c: Readonly<Vec3>, d: Readonly<Vec3>, t: number): Vec3 => {
 ...
 * @returns {vec3} out
 */
export const bezier = (out: Vec3, a: Readonly<Vec3>, b: Readonly<Vec3>, c: Readonly<Vec3>, d: Readonly<Vec3>, t: number): Vec3 => {
